...
with open("cache/dataset/llava/llava_minigpt4qwen_format.json", 'r') as f:
    pretrain_data = json.load(f)
with open("cache/dataset/minigpt4/minigpt4_minigpt4qwen_format.json", 'r') as f:
